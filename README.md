...
BrickMissing 8.4.2 ist der Django-Neuaufbau der LEGO-Sammlungs- und
...
> Release-Status: **8.4.2 – Production Sign-off ausstehend**. Der V8-Runtimepfad
...
Finaler Stand: 520/520 Django-Tests, Ruff, Django Check, Migration-Drift, Restore/Reconciliation, echte MariaDB-Concurrency und ausführbare Release-/Rollback-Tests PASS. `check --deploy` meldet nur W005/W021 als Operatorentscheidungen. Production Ready: YES.
