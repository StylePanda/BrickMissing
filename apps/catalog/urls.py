...
urlpatterns = [
    ...
    path("sets/<uuid:set_pk>/inventar/<int:pk>/bestand/", views.set_inventory_quantity, name="set_inventory_quantity"),
    ...
    path("fehlteile/<uuid:pk>/bestand/", views.missing_part_quantity, name="missing_part_quantity"),
    path("fehlteile/<uuid:pk>/status/", views.missing_part_status, name="missing_part_status"),
